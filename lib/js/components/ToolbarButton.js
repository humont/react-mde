...
exports.ToolbarButton = function (props) {
    var buttonComponentClass = props.buttonComponentClass, buttonContent = props.buttonContent, buttonProps = props.buttonProps, onClick = props.onClick, readOnly = props.readOnly, name = props.name, customButtonComponent = props.customButtonComponent;
    ...
    if (!!customButtonComponent) {
        return React.createElement("li", { className: "mde-header-item" }, customButtonComponent);
    }
